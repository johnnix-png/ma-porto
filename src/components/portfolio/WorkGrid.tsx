...
const WorkGrid: React.FC = () => {
  ...
  return (
    <section id="work" className="relative py-16 md:py-24  bg-gray-300" >
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          ...
          >
             <video
    src="https://res.cloudinary.com/dti4mtjlf/video/upload/v1754897871/video_qcqdpc.mp4"  // replace with your video URL
    autoPlay
    muted
    loop
    playsInline
  ...
  />  
            ...
            <p className="text-muted-foreground">Long & Short form video projects</p>
          </button>
          ...
          >
             <video
    src="https://res.cloudinary.com/dti4mtjlf/video/upload/v1754897870/graph_w20cqj.mp4"  // replace with your video URL
    autoPlay
    muted
    loop
    playsInline
  ...
  />
            ...
            <p className="text-muted-foreground">Thumbnails, posters, and logos</p>
          </button>
        </div>
      </div>
    </section>
